...
export const aboutData = {
  img: '',
  paragraphOne: `Je m'appelle Olivier Hang et je suis un développeur junior. Avant d'être développeur, je suis surtout une personne qui aime créer, apprendre et se surpasser.`,
